...
# Test the limit N SecretIntegers within a single Secret (store id)
# `python3 store_n_secret_integers_1_storeid.py --number_secret_integers 200`
...
async def main(args = None):
    ...
    print(f"The secrets are stored at store_id: {store_id}")
