...
def nada_main():
    ...
    my_array_1 = Vector(SecretInteger(Input(name="my_array_1", party=party1)), size=10)
    my_array_2 = Vector(SecretInteger(Input(name="my_array_2", party=party2)), size=10)
    ...
    out2 = Output(new_array, "zip.map.reduce.vector", party1)
