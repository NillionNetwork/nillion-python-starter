...
# 1 Party running raising a secret integer to the power of a public integer
...
async def main():
    ...
    program_id=f"{user_id}/power_simple"
    party_name="Party1"
    ...
    public_variables = nillion.PublicVariables({
        "public_my_int3": nillion.PublicVariableInteger(4)
    })
